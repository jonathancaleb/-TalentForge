...
const FEATURES = [
  {
    src: featureFreeSrc,
    title: "Free Forever",
    text: "WorkFolio is created with the belief that everyone should have free and easy access to a modern professional resume design",
  },
  {
    src: featureUSSrc,
  ...
  },
  {
    ...
    title: "Privacy Focus",
    text: "WorkFolio stores data locally in your browser so only you have access to your data and with complete control",
  },
  {
